...
SRC			=	$(SRC_DIR)/main.c										\
				...
				$(SRC_DIR)/shellft/shell_tsh.c							\
				$(SRC_DIR)/shellft/shell_tsh_del.c						\
				$(SRC_DIR)/shellft/shell_envsort.c						\
				$(SRC_DIR)/shellft/shell_envchr.c						\
				$(SRC_DIR)/shellft/shell_envini.c						\
				$(SRC_DIR)/shellft/shell_envdup.c						\
				$(SRC_DIR)/shellft/shell_envdup_lst.c					\
				$(SRC_DIR)/shellft/shell_envarr_mod.c					\
				$(SRC_DIR)/shellft/shell_envlst_mod.c					\
				$(SRC_DIR)/shellft/shell_split.c						\
				$(SRC_DIR)/shellft/shell_sigdlr.c						\
				$(SRC_DIR)/shellft/shell_newenv.c						\
				$(SRC_DIR)/shellft/shell_newpmt.c						\
				$(SRC_DIR)/shellft/shell_newtkn.c						\
				$(SRC_DIR)/shellft/shell_memmove.c						\
				$(SRC_DIR)/shellft/shell_env_utils.c					\
				$(SRC_DIR)/shellft/shell_split_chr.c					\
